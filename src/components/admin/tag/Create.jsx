...
const Create = () => {
  ...
  const handleSubmit = (e) => {
    ...
    axios.post(`${apiUrl}/tags`, formData, {
      headers: {
    ...
    .then((res) => {
      if (res.data.status) {
        ...
        toast.error(res.data.message || "Failed to create tag");
      }
    })
    .catch((error) => {
  ...
  return (
    <AdminLayout pageTitle={"Create tag"}>
      <div className="p-4">
        ...
        <Row className="justify-content-center">
          <Col lg={8}>
            <Card className="border-0 shadow-sm rounded-4 p-4 bg-white">
              <h6 className="fw-bold mb-4">Create New tag</h6>
