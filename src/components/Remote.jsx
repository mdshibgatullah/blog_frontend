...
const Remote = () => {
  return (
    <Layouts>
      <div 
        className="sub-hero position-relative overflow-hidden d-flex align-items-center justify-content-center "
        style={{ minHeight: '220px' }} 
      >

        <img src={remoteBg} alt="Remote Background" 
          className="position-absolute top-0 start-0 w-100 h-100 object-fit-cover"/>

        <div className="text-center position-relative py-5 px-3">
          <h1 className="fw-bold text-dark display-5 mb-3">
            Remote Jobs
          </h1>
          <p className="text-secondary fs-5 mb-4 mx-auto" style={{ maxWidth: '550px' }}>
            Discover hand-picked remote jobs from top companies and work from anywhere in the world.          </p>
          ...
          <Row className="justify-content-center align-items-center g-3 mt-2">
            ...
            <Col xs="auto">
              <div className="stat-card">
                <div className="stat-icon icon-active-jobs">
                  <FaBriefcase />
                </div>
            ...
            <Col xs="auto">
              <div className="stat-card">
                <div className="stat-icon icon-remote">
                  <FaGlobe />
                </div>
                <div className="text-start">
